...
The `xrv9k-tcpdump` maintainers take all security issues in the project
seriously. Thank you for improving the security of `xrv9k-tcpdump`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`xrv9k-tcpdump` leverages GitHub's private vulnerability reporting.
